            ...
            <div className="absolute top-3 right-3 flex gap-2">
              <button
                ...
                className={`w-10 h-10 rounded-full backdrop-blur-md flex items-center justify-center transition-all ${
                  isSaved ? "bg-gradient-to-br from-[#0D9488] to-[#14B8A6] text-white" : "bg-white/95 text-gray-800 hover:bg-white"
                }`}
              >
                <Bookmark className={`w-5 h-5 ${isSaved ? "fill-white" : ""}`} />
              </button>
              <button className="w-10 h-10 rounded-full bg-white/95 backdrop-blur-md flex items-center justify-center hover:bg-white transition-all">
